...
import { AnimatedCollapsible, CollapsibleHeader } from '@/components/motion'
...
export function PhasePanel({
    ...
    return (
        <div className={cn(
            ...
            open ? 'border-border/80 shadow-sm shadow-primary/5' : 'border-border/60 hover:border-border/80'
        )}>
