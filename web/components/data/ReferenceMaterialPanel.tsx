...
export function ReferenceMaterialPanel({ buildId, orgId, canEdit }: ReferenceMaterialPanelProps) {
    ...
    return (
        <div className={cn(
            'border rounded-lg overflow-hidden border-primary/30 bg-primary/[0.02] transition-all duration-300 ease-snappy',
            open && 'shadow-sm shadow-primary/10'
        )}>
                    ...
                    {canEdit && (
                        <div className="rounded-lg border bg-muted/10 p-4 space-y-4">
                            ...
                            <div
                                ...
                                className={cn(
                                    'border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-all duration-200 ease-snappy interactive active:scale-[0.99]',
                                    dragging
                    ...
                    <div>
                        ...
                        {loading ? (
                            <div className="py-8 flex justify-center">
                                <FuturisticLoader size="md" label="Loading references…" />
                            </div>
                        ) : references.length === 0 ? (
